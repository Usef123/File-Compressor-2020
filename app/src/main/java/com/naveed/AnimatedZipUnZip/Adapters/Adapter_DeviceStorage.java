...
public class Adapter_DeviceStorage extends RecyclerView.Adapter<Adapter_DeviceStorage.MyViewHolder> {
    ...
    public Adapter_DeviceStorage(ArrayList<FilesModelClass> foldername, Context context, Onfolderlistner onfolderlistner) {
